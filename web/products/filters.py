...
class ProductFilter(django_filters.FilterSet):
    ...
    price__gt = django_filters.NumberFilter(field_name='price', lookup_expr='gte', label='Preț minim')
    price__lt = django_filters.NumberFilter(field_name='price', lookup_expr='lte', label='Preț maxim')
