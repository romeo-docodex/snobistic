    ...
    $desktopMenu.find("> li.menu-item").each(function (i, menuItem) {
        ...
        if (text.toLowerCase() === "home") {
          const $li = $(`
              <li class="nav-mb-item">
                  <a href="#${id}" class="collapsed mb-menu-link mobile-header-link" data-bs-toggle="collapse" aria-expanded="false" aria-controls="${id}">
                      <span>${text}</span>
        ...
        if (submenu.hasClass("mega-tab")) {
            ...
            submenu.find(".menu-tab .tab-link").each(function (j) {
                ...
                const $tabGroup = $(`
                    <li>
                        <a href="#${subId}" class="collapsed sub-nav-link mobile-header-link" data-bs-toggle="collapse" aria-expanded="false" aria-controls="${subId}">
                            <span>${tabText}</span>
                            <span class="btn-open-sub"></span>
                        </a>
            ...
            submenu.find(".mega-menu-item").each(function (j) {
                ...
                $(this).find(".menu-list a").each(function () {
                    ...
                    const title = $(this).text().trim();
                    if (title !== "") {
                        $group.find(".sub-menu-level-2").append(`<li><a href="${link}" class="sub-nav-link mobile-header-link">${title}</a></li>`);
                    }
                });
            ...
            if ($subNav.children().length === 0) {
                submenu.find("a").each(function () {
                    ...
                    const title = $(this).text().trim();
                    if (title !== "") {
                        $subNav.append(`<li><a href="${link}" class="sub-nav-link mobile-header-link">${title}</a></li>`);
                    }
                });
            }
            ...
            $mobileMenu.append(`<li class="nav-mb-item"><a href="${$item.find("a").attr("href")}" class="mb-menu-link mobile-header-link"><span>${text}</span></a></li>`);
        }
    });
